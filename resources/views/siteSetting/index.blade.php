    ...
    <div class="rightlist">
        ...
        <div id="test-vue">
            <el-form ref="form" :model="form" label-width="17%">
                ...
                <el-form-item label="商品库存缓存">
                    <el-radio v-model.bool="form.stock_cache" :label=1>开启</el-radio>
                    <el-radio v-model.bool="form.stock_cache" :label=0>关闭</el-radio>
                    <div>开启后可以解决秒杀等场景下商品的超卖问题(库存的修改和展示会优先使用缓存,商品数据库中的库存会通过队列延迟更新),集群服务器开启前必须将缓存修改为redis</div>
                </el-form-item>
                <el-form-item>
