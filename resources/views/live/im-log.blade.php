        ...
        <table class="table table-" style="table-layout:fixed;">
            ...
            @foreach($list as $row)
                <tr>
                    ...
                    <td style="text-align: left;white-space: normal;word-break: break-all;">@if($row->msg_type == 1) {{$row->msg_content->Text}} @elseif($row->msg_type == 4) {{$row->msg_content->Data}} {{$row->msg_content->Ext}} @endif</td>
