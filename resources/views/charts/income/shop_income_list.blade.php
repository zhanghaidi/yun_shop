                    ...
                    <table class='table order-title table-hover table-striped'>
                        ...
                        @foreach($list as $row)
                            <tr style="height: 40px; text-align: center">
                                ...
                                <td>@if($row->plugin_id == 92) {{\Yunshop\Supplier\common\models\SupplierOrder::where('order_id',$row->order_id)->with(['supplier'])->first()['supplier']['username']}} @else{{ $row['shop_name'] }} @endif</td>
