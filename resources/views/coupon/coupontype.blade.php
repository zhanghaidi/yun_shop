...
<div class="form-group">
    <label class="col-xs-12 col-sm-3 col-md-2 control-label">领取条件 - 会员等级</label>
    <div class="col-sm-9 col-xs-12">
...
<div class="form-group">
    ...
    <div class="col-sm-9 col-xs-12">
        <label class="radio-inline"><input type="radio" name="coupon[use_type]" onclick='showusetype(0)' value="0" checked>平台自营商品（不包含供应商商品）</label>
