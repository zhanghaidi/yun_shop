...
<div class="form-group">
    ...
    <div class="col-sm-2 backtype backtype0" @if($coupon['coupon_method']!=1)style='display:none' @endif>
        <div class='input-group'>
            ...
            <input type='text' class='form-control' name='coupon[deduct]' value="{{$coupon['deduct']?$coupon['deduct']:0}}"/>
    ...
    <div class="col-sm-2 backtype backtype1"  @if($coupon['coupon_method']!=2)style='display:none' @endif>
        <div class='input-group'>
            ...
            <input type='text' class='form-control' name='coupon[discount]'  placeholder='1-9' value="{{$coupon['discount']?$coupon['discount']:0}}"/>
