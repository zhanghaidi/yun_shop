            ...
            <div class='panel-body'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        ...
                        <label class='radio-inline sms_type' type="5"><input type='radio' name='sms[type]' value='5' @if  ($set['type'] == 5) checked @endif /> 腾讯云</label>
                    </div>
                </div>

                <div id="sms1" @if ($set['type'] == 2 || $set['type'] == 3 || $set['type'] == 5) class="hide" @endif>
                    <div class="form-group">
                ...
                <div id="sms2"  @if ($set['type'] == 1 || $set['type'] == 3 || $set['type'] == 5 || !$set['type']) class="hide" @endif>
                    <div class="form-group">
                ...
                <div id="sms3" @if ($set['type'] == 1 || $set['type'] == 2 || $set['type'] == 5 || !$set['type']) class="hide" @endif>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
                        <div class="col-sm-9 col-xs-12 alert alert-info">
                ...
                <div id="sms5" @if ($set['type'] == 1 || $set['type'] == 2  || $set['type'] == 3 || !$set['type']) class="hide" @endif>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label"></label>
                        <div class="col-sm-9 col-xs-12 alert alert-info">
                            请到 <a href='https://cloud.tencent.com' taget="_blank">腾讯云</a> 去申请开通
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">SDKAppID :</label>
                        <div class="col-sm-9 col-xs-12">
                            <input type="text" name="sms[tx_sdkappid]" class="form-control" value="{{ $set['tx_sdkappid'] }}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">AppKey :</label>
                        <div class="col-sm-9 col-xs-12">
                            <input type="text" name="sms[tx_appkey]" class="form-control" value="{{ $set['tx_appkey'] }}" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">短信签名:</label>
                        <div class="col-sm-9 col-xs-12">
                            <input type="text" name="sms[tx_signname]"
                                   class="form-control"
                                   value="{{ $set['tx_signname'] }}" placeholder="例如: 注册验证" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">注册模板ID:</label>
                        <div class="col-sm-9 col-xs-12">
                            <input type="text" name="sms[tx_templateCode]" class="form-control" value="{{ $set['tx_templateCode'] }}"  placeholder="例如: SMS_5057806" />
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">找回密码模板ID:</label>
                        <div class="col-sm-9 col-xs-12">
                            <input type="text" name="sms[tx_templateCodeForget]" class="form-control" value="{{ $set['tx_templateCodeForget'] }}"  placeholder="例如: 598776" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">余额定时提醒:</label>
                        <div class="col-sm-9 col-xs-12">
                            <input type="text" name="sms[tx_templateBalanceCode]" class="form-control" value="{{ $set['tx_templateBalanceCode'] }}"  placeholder="例如: 598776" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">商品发货提醒:</label>
                        <div class="col-sm-9 col-xs-12">
                            <input type="text" name="sms[tx_templateSendMessageCode]" class="form-control" value="{{ $set['tx_templateSendMessageCode'] }}"  placeholder="例如: 598776" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">会员充值提醒:</label>
                        <div class="col-sm-9 col-xs-12">
                            <input type="text" name="sms[tx_templatereChargeCode]" class="form-control" value="{{ $set['tx_templatereChargeCode'] }}"  placeholder="例如: 598776" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">灸师发短信模板ID:</label>
                        <div class="col-sm-9 col-xs-12">
                            <input type="text" name="sms[tx_templateJiushiSmsCode]" class="form-control" value="{{ $set['tx_templateJiushiSmsCode'] }}"  placeholder="例如: 598776" />
                        </div>
                    </div>
                </div>
