        ...
        <div class="panel panel-default">
			...
			<div class='panel-body'>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class='help-block'>
                            1.订单下单未付款，n天后自动关闭，0/空为不自动关闭<br/>
                            2.退换货处理中的订单不能自动关闭<br/>
                        </span>
                    </div>
                </div>
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						...
						<span class='help-block'>执行自动关闭未付款订单操作的间隔时间，如果为空默认为 5分钟 执行一次关闭到期未付款订单</span>
					</div>
				</div>
			</div>
			...
			<div class='panel-body'>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class='help-block'>
                            1.订单发货后，用户收货的天数，如果在期间未确认收货，系统自动完成收货，0/空为不自动收货<br/>
                            2.退换货处理中的订单不能自动收货<br/>
                            3.配送方式为自提,酒店入住,配送站送货,司机配送,自提点的配送类型不支持自动收货</span>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <span class='help-block'>执行自动收货操作的间隔时间，如果为空默认为 5分钟 执行一次自动收货</span>
                    </div>
                </div>
			</div>
			<div class="panel-heading">
            ...
            <div class='panel-body'>
                ...
                <div class="form-group">
                    ...
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">地址是否需要区域</label>
                    <div class="col-sm-9 col-xs-12">

                        <label class='radio-inline'><input type='radio' name='trade[is_region]' value='0' @if (empty($set['is_region']) || $set['is_region'] == 0) checked @endif/> 开启</label>
                        <label class='radio-inline'><input type='radio' name='trade[is_region]' value='1' @if ($set['is_region'] == 1) checked @endif /> 关闭</label>
