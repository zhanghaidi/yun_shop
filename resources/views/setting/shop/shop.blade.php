        ...
        <div class="panel panel-default">
            <div class='panel-body'>
                ...
                <div class="form-group">
                    ...
                    @if(\app\common\models\user\WeiQingUsers::getUserByUid(\YunShop::app()->uid)->first()['status'] == 0) {{--判断是不是超级管理员--}}
                        <div class="form-group">
                            <label class="col-xs-12 col-sm-3 col-md-2 control-label">版权图片</label>
                            <div class="col-sm-9 col-xs-12">
                                {!! app\common\helpers\ImageHelper::tplFormFieldImage('shop[copyrightImg]', $set['copyrightImg']) !!}
                                <span class='help-block'>版权图片，建议尺寸宽度240px</span>
                            </div>
                        </div>
                    @endif
                <div class="form-group">
