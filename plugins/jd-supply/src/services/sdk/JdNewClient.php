...
class JdNewClient
{
    ...
    public static function get($methodOrUri,JdNewRequest $JdRequest)
    {
        if(!self::verification($JdRequest)) {
            return json_encode('appKey 或 appSecret 不能为空');
        }

        $JdRequest->addParam('Api-Sign', self::setSign($JdRequest->getAllParam(), $JdRequest->getAppSecret()));
        ...
        $headers = array(
            'Api-App-Key' => $JdRequest->paramMap['Api-App-Key'],
            'Api-Time-Stamp' => $JdRequest->paramMap['Api-Time-Stamp'],
            'Api-Nonce' => $JdRequest->paramMap['Api-Nonce'],
            'Api-Sign'=> $JdRequest->paramMap['Api-Sign']
        );
        return self::curl_request($serverUrl, false ,$headers);
    }

    public static function getBody($methodOrUri,JdNewRequest $JdRequest)
    {
        if(!self::verification($JdRequest)) {
            return json_encode('appKey 或 appSecret 不能为空');
        }

        $JdRequest->addParam('Api-Sign', self::setSign($JdRequest->getAllParam(), $JdRequest->getAppSecret() ,$JdRequest->body));
        $serverUrl = self::richRequest($methodOrUri, $JdRequest);
        ...
        return self::curl_get_body_request($serverUrl, $JdRequest->body ,$headers);
    }

    public static function post($methodOrUri,JdNewRequest $JdRequest)
    {
        ...
        return self::curl_request($serverUrl, $JdRequest->body,$headers);
    }



    public static function patch($methodOrUri,JdNewRequest $JdRequest)
    {
        ...
        return self::curl_patch_request($serverUrl, $JdRequest->body,$headers);
    }


    public static function verification(JdNewRequest $JdRequest)
    {
     ...
     * @return string
     */
    public static  function richRequest($methodOrUri, JdNewRequest $JdRequest)
    {
