        ...
        <div class="rightlist">
                            ...
                            <form  action="" method="get" class="form-horizontal" id="form1">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-7 col-lg-9 col-xs-12">
                                        ...
                                        <button type="submit" name="export" value="1" id="export" class="btn btn-info">
                                            导出 Excel
                                        </button>
            ...
            <div class="panel panel-default">
                ...
                @section('is_plugin')
                                ...
                                @foreach( $order['has_many_order_goods'] as $order_goods_index => $order_goods)
                                    <tr class='trbody'>
                                        ...
                                        <td class="top" valign='top' style="font-size: 6px;color: #AEB9C0">
                                            <a href="{{yzWebUrl('plugin.jd-supply.admin.shop-goods.edit', array('id' => $order_goods['goods_id']))}}">{{$order_goods['title']}}</a>
                    ...
                    @endforeach
                @show
                @include('Yunshop\JdSupply::admin.order.modals')
