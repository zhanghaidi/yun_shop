            ...
            <div class="form-group options">
                ...
                <div class="col-xs-12 col-sm-8 col-md-9 col-sm-offset-3 col-md-offset-2">
                    <label class="radio-inline">
                        <input type="radio" name="data[answer]" value="{{$v['name']}}" @if($v['option']) checked @endif /> 设为正确答案
                    </label>
                </div>
            </div>
            @endforeach
@else
            <div class="form-group options">
                ...
                <div class="col-xs-12 col-sm-8 col-md-9 col-sm-offset-3 col-md-offset-2">
                    <label class="radio-inline">
                        <input type="radio" name="data[answer]" value="A" /> 设为正确答案
                    </label>
                </div>
            </div>
            <div class="form-group options">
                ...
                <div class="col-xs-12 col-sm-8 col-md-9 col-sm-offset-3 col-md-offset-2">
                    <label class="radio-inline">
                        <input type="radio" name="data[answer]" value="B" /> 设为正确答案
                    </label>
                </div>
            </div>
            <div class="form-group options">
                ...
                <div class="col-xs-12 col-sm-8 col-md-9 col-sm-offset-3 col-md-offset-2">
                    <label class="radio-inline">
                        <input type="radio" name="data[answer]" value="C" /> 设为正确答案
                    </label>
                </div>
            </div>
            <div class="form-group options">
                ...
                <div class="col-xs-12 col-sm-8 col-md-9 col-sm-offset-3 col-md-offset-2">
                    <label class="radio-inline">
                        <input type="radio" name="data[answer]" value="D" /> 设为正确答案
                    </label>
                </div>
            </div>
@endif
    ...
    <script language="JavaScript">
        ...
        function addAnswerItem() {
            ...
            _html += '<input type="radio" name="data[answer]" value="X" /> 设为正确答案';
            _html += '</label></div></div>';
