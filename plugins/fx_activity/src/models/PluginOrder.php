...
class PluginOrder extends BaseModel
{
    public $table = 'yz_fx_activity_order';
...
//        dd($search['is_time']);
        ...
        $order_Model = $order_Model->with('hasOneOrder')->select('id','order_id','order_sn','goods_price','price','created_at','buyer_name','status','recommend_name');
        return $order_Model;
    }
