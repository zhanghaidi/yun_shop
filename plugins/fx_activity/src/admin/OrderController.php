...
use Yunshop\FxActivity\models\PluginOrder;
use Yunshop\FxActivity\models\Order;
use Yunshop\FxActivity\models\IpWhiteList;
use Yunshop\FxActivity\listeners\OrderReceiveListener;
...
class OrderController extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('Yunshop\FxActivity::admin.orders',[
            'list' => $list->toarray(),
            'pager' => $pager,
            'total' => $list->total(),
            'search' => $search,
...
//        ];
    ...
    public function export()
    {
        ...
        $file_name = date('Ymdhis', time()) . '活动报名导出';
        ...
        $export_model->export($file_name, $export_data, 'Yunshop\FxActivity::admin.orders');
        return true;
    }
}