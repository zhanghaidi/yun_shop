                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12">
                            <label class="radio-inline">
                                <input type="radio" name="slide[status]" value="1" @if ($slideModel->status == 1) checked @endif /> 是
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="slide[status]" value="0" @if ($slideModel->status == 0 ) checked @endif/> 否
                            </label>
                        </div>
                    </div>
