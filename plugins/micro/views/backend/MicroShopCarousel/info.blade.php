                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span
                                    style="color:red">*</span>图片轮播标题</label>
                        <div class="col-sm-9 col-xs-12">
                    ...
                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">图片轮播图片</label>
                        <div class="col-sm-9 col-xs-12">
                            {!! app\common\helpers\ImageHelper::tplFormFieldImage('slide[thumb]', $slideModel->thumb)!!}
                            <span class="help-block">建议尺寸:640 * 250 , 请将所有图片轮播图片尺寸保持一致 </span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-xs-12 col-sm-3 col-md-2 control-label">图片轮播连接</label>
                        <div class="col-sm-9 col-xs-12">
        ...
        require(['bootstrap'], function ($) {
            $('form').submit(function () {
                if ($(':input[name=slide[slide_name]]').isEmpty()) {
                    Tip.focus(':input[name=slide[slide_name]]', '请输入图片轮播标题!');
                    return false;
                }
                return true;
            });
