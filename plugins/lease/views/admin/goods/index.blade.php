        ...
        <div id="goods-index" class=" rightlist ">
            {{--<div class="right-titpos">
                <ul class="add-snav">
                    ...
                    @section('add_goods')
                        <a class='btn btn-primary' href="{{yzWebUrl('plugin.lease-toy.admin.goods.create')}}" style="margin-bottom:5px;"><i class='fa fa-plus'></i> 发布{{$lang['good']}}</a>
                    @show
                ...
                <form id="goods-list" action="{!! yzWebUrl($sort_url) !!}" method="post">
                    <div class="panel panel-default">
                        ...
                        <div style="margin-left:13px;margin-top:8px">
                            @section('add_goods')
                            <a class='btn btn-success ' href="{{yzWebUrl('plugin.lease-toy.admin.goods.create')}}"><i
