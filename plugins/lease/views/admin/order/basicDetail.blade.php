...
@include('Yunshop\LeaseToy::admin.order.lease-detail')
    ...
    <div class="panel-body table-responsive">
        <table class="table table-hover">
            ...
            <tr>
                ...
                <th class="col-md-5 col-lg-2">原价格(元/天)<br/>折扣后(元/天)</th>
                <th class="col-md-5 col-lg-2">押金</th>
                <th class="col-md-5 col-lg-1">购买数量</th>
                <th class="col-md-5 col-lg-1">租赁天数</th>
                <th class="col-md-5 col-lg-2" style="color:red;">租赁金额</th>
                <th class="col-md-5 col-lg-2" style="color:red;">押金金额</th>
            ...
            @foreach ($order['has_many_order_goods'] as $order_goods)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{yzWebUrl('plugin.lease-toy.admin.goods.edit', array('id' => $order_goods['goods_id']))}}">{{$order_goods['title']}}</a>
                    </td>
                   ...
                   <!--  <td>{{$order_goods['goods_price']}}
                    ...
                    <td>￥{{$order_goods['has_one_lease_order_goods']['deposit']}}</td>
                    <td>{{$order_goods['total']}}</td>
                    <td>{{$order_goods['has_one_lease_order_goods']['return_days']}}</td>
                    <td style='color:red;font-weight:bold;'>￥{{$order_goods['price']}}</td>
                    <td style='color:red;font-weight:bold;'>
                        ￥{{$order_goods['has_one_lease_order_goods']['free_deposit']}}
                    </td>
                    <td>
                        <a href="{!! yzWebUrl('plugin.lease-toy.admin.goods.edit', array('id' => $order_goods['goods']['id'])) !!}"
