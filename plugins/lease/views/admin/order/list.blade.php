                                ...
                                <tr>
                                    <td class="left" colspan='8'>
                                        ...
                                        <label class="label label-info">总店</label>
                                         ...
                                         @if(!empty($order['has_one_refund_apply']) && empty($order['has_one_lease_toy_order']['return_status']))
                                            <label class="label label-danger" style="background-color: #ccc;color:#FFECF6;">{{$order['has_one_refund_apply']['refund_type_name']}}
                                                :{{$order['has_one_refund_apply']['status_name']}}</label>
                                        @endif


                                        @if($order['status'] >= 2)
                                            <label class="label label-danger">归还
                                                :{{$order['has_one_lease_toy_order']['return_name']}}</label>
                                            ...
                                            <td rowspan="{{count($order['has_many_order_goods'])}}" style='width:18%;'>
                                                ...
                                                $order['dispatch_price'],2) !!}
                                                    ...
                                                    <tr>
                                                        <td style=''>押金：</td>
                                                        <td style=''>￥{!! number_format(
                                                $order['lease_toy']['deposit_total'],2) !!}
                                                        </td>
                                                    </tr>
