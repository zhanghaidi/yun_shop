                    ...
                    @foreach($item->hasManyOrderGoods as $k => $g)
                        <tr class='trbody' id="ordergoodstr">
                            ...
                            <td id="orderinfo" valign='top' colspan='2' style='text-align: left; width: 400px; position: relative; '
                                ...
                                data-shorttitle = "@if(!$g->goods->hasOneShort)-@else{{$g->goods->hasOneShort->short_title}}@endif" data-goodnum="{{$g->total}}" data-goodssn="{{$g->goods->goods_sn}}" data-productsn="{{$g->goods->product_sn}}" data-marketprice="{!! $g->goods->market_price !!}"
                                data-productprice="{!! $g->goods->price !!}" data-total="{{$g->total}}" data-goodoption="@if(!$g->goods_option_title)-@else{{$g->goods_option_title}}@endif" data-goodunit="@if(!$g->goods->sku)-@else{{$g->goods->sku}}@endif"
                                ...
                                <span class='goodtitle' >@if(!$g->goods->hasOneShort)-@else{{$g->goods->hasOneShort->short_title}}@endif</span>
