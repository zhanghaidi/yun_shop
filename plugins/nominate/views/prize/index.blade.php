        ...
        <div class="clearfix">
            <div class="panel panel-default">
                <div class="panel-heading">
                    总数：{{ $list->total() }}
                    <br>
                    累计{{ $set['nominate_prize_name']?:'直推奖' }}金额: {{ $amountTotal }}元
                </div>
                <div class="panel-body">
                    <table class="table table-hover" style="overflow:visible;">
                        ...
                        <tr>
                            ...
                            <th style='text-align: center'>{{ $set['nominate_prize_name']?:'直推奖' }}金额</th>
    ...
    <script language='javascript'>
        $(function () {
            $('#export').click(function(){
                $('#form1').get(0).action="{!! yzWebUrl('plugin.nominate.admin.prize.export') !!}";
                $('#form1').submit();
                $('#form1').get(0).action="{!! yzWebUrl('plugin.nominate.admin.prize.index') !!}";
            });
        });
    </script>
@endsection