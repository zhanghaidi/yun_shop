        ...
        <div class="panel panel-info">
            <div class="panel-body">
                <form action="" method="post" class="form-horizontal" role="form" id="form1">
                    ...
                    <div class="form-group col-xs-12 col-sm-2 col-md-2 col-lg-2 ">
                        <div class="">
                            <input type="text" placeholder="订单编号" class="form-control"  name="search[order_sn]" value="{{$search['order_sn']}}"/>
                        </div>
                    </div>
        ...
        <div class="clearfix">
            <div class="panel panel-default">
                <div class="panel-heading">
                    总数：{{ $list->total() }}
                    <br>
                    累计{{ $set['team_manage_prize_name']?:'团队业绩奖' }}金额: {{ $amountTotal }}元
                </div>
                <div class="panel-body">
                    <table class="table table-hover" style="overflow:visible;">
                        ...
                        @foreach($list as $item)
                            <tr style="text-align: center">
                                ...
                                <td style="text-align: center;">
                                    <a href="{!! yzWebUrl('order.detail', ['id'=>$item->order_id]) !!}">
                                        {{ $item->order->order_sn }}</a>
                                </td>
                                <td style="text-align: center;">
                                    {{ $item->order->price }}
                                </td>
    ...
    <script language='javascript'>
        $(function () {
            $('#export').click(function(){
                $('#form1').get(0).action="{!! yzWebUrl('plugin.nominate.admin.team-manage-prize.export') !!}";
                $('#form1').submit();
                $('#form1').get(0).action="{!! yzWebUrl('plugin.nominate.admin.team-manage-prize.index') !!}";
            });
        });
    </script>
@endsection