...
class LoveReturnLogController extends BaseController
{
    protected $pageSize;
    protected $loveName;
    ...
    public function index()
    {
        ...
        $list = LoveReturnLogModel::getLoveReturnLog($search)->orderBy('id', 'desc')->paginate($this->pageSize);
        ...
        return view('Yunshop\Love::Backend.Love.return-log', [
            'list' => $list,
            'pager' => $pager,
            'search' => $search,
