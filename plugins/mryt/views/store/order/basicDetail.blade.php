        ...
        <table class="table table-hover">
            ...
            @foreach ($order['has_many_order_goods'] as $order_goods)
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{yzWebUrl('plugin.store-cashier.admin.goods.edit', array('id' => $order_goods['goods_id']))}}">{{$order_goods['title']}}</a>
                    </td>
                    ...
                    <td>
                        <a href="{!! yzWebUrl('plugin.store-cashier.admin.goods.edit', array('id' => $order_goods['goods']['id'])) !!}"
