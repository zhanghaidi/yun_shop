                ...
                <div class="panel panel-default">
                    <div class="panel-body table-responsive">
                        <table class="table table-hover">
                            ...
                            @foreach($slide as $row)
                                <tr>
                                    ...
                                    <td style="text-align:left;">
                                        <a href="{{yzWebUrl("plugin.supplier.supplier.controllers.slide.edit",['id'=>$row['id']])}}"
                                           class="btn btn-default btn-sm" title="{修改"><i class="fa fa-edit"></i></a>
                                        <a href="{{yzWebUrl("plugin.supplier.supplier.controllers.slide.deleted",['id'=>$row['id']])}}" class="btn btn-default btn-sm" onclick="return confirm('确认删除此幻灯片?');"
                            ...
                            <tr>
                                <td colspan='6'>
                                    <a class='btn btn-primary' href="{{yzWebUrl("plugin.supplier.supplier.controllers.slide.create")}}"><i
