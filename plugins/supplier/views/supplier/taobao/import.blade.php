                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                @elseif ($function == 'yzGoods')
                                    ...
                                    <span class="help-block">例如商品链接为: https://www.yunzmall.com/addons/yun_shop/?menu#/goods/600?i=10,直接输入商品链接或输入商品ID:600</span>
                                    <span class="help-block">每行仅限输入一个链接或一个商品ID可多行输入</span>
                                @endif
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input id="function" type="hidden"
                               value="@if($function == 'taobao') {!!  yzWebUrl('plugin.supplier.supplier.controllers.taobao.import.taobao')  !!} @elseif($function == 'jingdong'){!!  yzWebUrl('plugin.goods-assistant.admin.import.jingdong')  !!} @elseif($function == 'alibaba'){!! yzWebUrl('plugin.goods-assistant.admin.import.alibaba') !!}@elseif($function == 'yzGoods'){!! yzWebUrl('plugin.goods-assistant.admin.import-yz.get-yz-goods') !!}@endif"/>
                    </div>
                </div>
            </form>
        </div>
