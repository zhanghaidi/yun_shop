...
<div id="modal-close" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="width:600px;margin:0px auto;">
    <form class="form-horizontal form" action="" method="post" enctype="multipart/form-data">
        <input type="hidden" name="route" value="plugin.supplier.supplier.controllers.order.operation.close">
...
<div id="modal-confirmsend" class="modal fade" role="dialog" style="width:600px;margin:0px auto;">
    <form class="form-horizontal form" action="" method="post"
        ...
        <input type='hidden' name='order_id' value=''/>
        <input type="hidden" name="i" value="{{YunShop::app()->uniacid}}" />
        <input type='hidden' name='route' value='plugin.supplier.supplier.controllers.order.operation.send' id="send_form"/>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
...
<div id="modal-cancelsend" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true"
    ...
    <form class="form-horizontal form" action="{!! yzWebUrl('plugin.supplier.supplier.controllers.order.operation.cancel-send') !!}" method="post"
          enctype="multipart/form-data">
        <input type='hidden' name='order_id' value=''/>
        <div class="modal-dialog">
            <div class="modal-content">
