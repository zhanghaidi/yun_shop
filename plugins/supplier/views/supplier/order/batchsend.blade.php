    ...
    <div class='form-group'>
        <div class="col-sm-12">
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="{{yzWebUrl('plugin.supplier.supplier.controllers.order.batchsend.getexample')}}" style="margin-right: 10px;" ><i class="fa fa-download" title=""></i> 下载Excel模板文件</a>
            </div>
        </div>
    </div>
    </div>
