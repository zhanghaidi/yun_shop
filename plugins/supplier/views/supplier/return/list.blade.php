        ...
        <form action="{{ yzWebUrl('goods.dispatch.sort') }}" method="post">
            <div class="main panel panel-default">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align:left;">
                                     <a href="{{ yzWebUrl('plugin.supplier.supplier.controllers.address.return-address.edit', ['id'=>$address['id']]) }}" class="btn btn-default btn-sm" title="修改"><i class="fa fa-pencil"></i></a>
                                     <a href="{{ yzWebUrl('plugin.supplier.supplier.controllers.address.return-address.delete', ['id'=>$address['id']]) }}" class="btn btn-default btn-sm" onclick="return confirm('确认删除此配送方式?')" title="删除"><i class="fa fa-times"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="panel-footer">
                    <a class="btn btn-info " href="{{ yzWebUrl('plugin.supplier.supplier.controllers.address.return-address.add') }}"><i class="fa fa-plus"></i> 添加退货地址</a>
                </div>
            </div>
        </form>
    </div>
