                ...
                <div class="third-list">
                        ...
                        <el-form :inline="true" :model="search_form" ref="search_form" style="margin-left:10px;">
                            <el-row>
                                ...
                                <el-form-item label="供应商">
                                    <el-select v-model="search_form.supplier_id" placeholder="请选择供应商" clearable>
                                        <el-option v-for="item in supplier_list" :key="item.id" :label="item.username" :value="item.id"></el-option>
                                    </el-select>
                                </el-form-item>
                    ...
                    <div class="table-list">
                        <div style="margin-left:10px;">
                            ...
                            <!-- <el-button size="small" type="danger" @click="batchDestroy">批量删除</el-button> -->
                        </div>
                        <div>
                            <template>
                                <!-- 表格start -->
                                <el-table :data="goods_list" style="width: 100%;" :class="table_loading==true?'loading-height':''" v-loading="table_loading">
                                    ...
                                    <el-table-column prop="be_longs_to_supplier.username" label="供应商" max-width="80" align="center"></el-table-column>
                                    ...
                                    <el-table-column label="操作" width="300" align="center">
                                        <template slot-scope="scope">
                                            <div class="table-option">
                                                ...
                                                &nbsp;&nbsp;
                                                <a :href="'{{ yzWebFullUrl('plugin.supplier.admin.controllers.goods.goods-operation.edit', array('id' => '')) }}'+[[scope.row.id]]" target="_blank">
                                                编辑
                                                </a>&nbsp;&nbsp;
    ...
    var app = new Vue({
        ...
        methods: {
            getData() {
                ...
                that.$http.post("{!! yzWebFullUrl('plugin.supplier.admin.controllers.goods.supplier-goods-list.goods-list') !!}").then(response => {
                    ...
                    if(response.data.result==1){
                        ...
                        that.supplier_list = response.data.data.all_supplier;
            ...
            search(page) {
                ...
                let json = {
                    ...
                    search:{
                        ...
                        supplier_id:that.search_form.supplier_id,
                    },
                    category:{
                ...
                that.table_loading = true;
                that.$http.post("{!! yzWebFullUrl('plugin.supplier.admin.controllers.goods.supplier-goods-list.goods-search') !!}",json).then(response => {
                    console.log(response);
                    if(response.data.result==1){
                        let arr = [];
