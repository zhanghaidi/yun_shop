        ...
        <div class="info">
            <div class="panel-body">
                <div class="tab-content">
                    <div class="tab-pane  active" id="tab_basic">@include('Yunshop\Supplier::admin.goods.basic')</div>
                ...
                <div class="form-group col-sm-12 mrleft40 border-t">
                    ...
                    <input type="button" name="supplier_back"  style='margin-left:10px;' value="返回列表" class="btn btn-default" />
                    <script type="text/javascript">
                        $("input[name='supplier_back']").click(function () {
                            location.href = "{!! yzWebUrl('plugin.supplier.admin.controllers.goods.supplier-goods-list') !!}";
                        });
                    </script>
                </div>
            </div>
