...
@section('content')
                ...
                <div class='panel panel-default'>
                    ...
                    <div class='panel-body'>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 col-xs-6">
                                <input class="mui-switch mui-switch-animbg" id="supplier_order_create" type="checkbox"
                                       @if(\app\common\models\notice\MessageTemp::getIsDefaultById($set['supplier_order_create']))
                                       checked
                                       @endif
                    ...
                    <div class='panel-body'>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 col-xs-6">
                                <input class="mui-switch mui-switch-animbg" id="supplier_order_pay" type="checkbox"
                                       @if(\app\common\models\notice\MessageTemp::getIsDefaultById($set['supplier_order_pay']))
                                       checked
                                       @endif
                                       onclick="message_default(this.id)"/>
                            </div>
                    ...
                    <div class='panel-body'>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 col-xs-6">
                                <input class="mui-switch mui-switch-animbg" id="supplier_order_send" type="checkbox"
                                       @if(\app\common\models\notice\MessageTemp::getIsDefaultById($set['supplier_order_send']))
                                       checked
                                       @endif
                                       onclick="message_default(this.id)"/>
                            </div>
                    ...
                    <div class='panel-body'>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 col-xs-6">
                                <input class="mui-switch mui-switch-animbg" id="supplier_order_finish" type="checkbox"
                                       @if(\app\common\models\notice\MessageTemp::getIsDefaultById($set['supplier_order_finish']))
                                       checked
                                       @endif
                                       onclick="message_default(this.id)"/>
                            </div>
                    ...
                    <div class='panel-body'>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 col-xs-6">
                                <input class="mui-switch mui-switch-animbg" id="supplier_withdraw_apply" type="checkbox"
                                       @if(\app\common\models\notice\MessageTemp::getIsDefaultById($set['supplier_withdraw_apply']))
                                       checked
                                       @endif
                                       onclick="message_default(this.id)"/>
                            </div>
                    ...
                    @if(YunShop::notice()->getNotSend('supplier.withdraw_ok_title'))
                        <div class='panel-body'>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2 col-xs-6">
                                    <input class="mui-switch mui-switch-animbg" id="supplier_withdraw_pass" type="checkbox"
                                           @if(\app\common\models\notice\MessageTemp::getIsDefaultById($set['supplier_withdraw_pass']))
                                           checked
                                           @endif
                                           onclick="message_default(this.id)"/>
                                </div>
                    ...
                    @if(YunShop::notice()->getNotSend('supplier.withdraw_no_title'))
                        <div class='panel-body'>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2 col-xs-6">
                                    <input class="mui-switch mui-switch-animbg" id="supplier_withdraw_reject" type="checkbox"
                                           @if(\app\common\models\notice\MessageTemp::getIsDefaultById($set['supplier_withdraw_reject']))
                                           checked
                                           @endif
                                           onclick="message_default(this.id)"/>
                                </div>
                    ...
                    @if(YunShop::notice()->getNotSend('supplier.withdraw_pay_title'))
                        <div class='panel-body'>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2 col-xs-6">
                                    <input class="mui-switch mui-switch-animbg" id="supplier_withdraw_play" type="checkbox"
                                           @if(\app\common\models\notice\MessageTemp::getIsDefaultById($set['supplier_withdraw_play']))
                                           checked
                                           @endif
                                           onclick="message_default(this.id)"/>
                                </div>
                    ...
                    @if(YunShop::notice()->getNotSend('supplier.apply_reject_title'))
                        <div class='panel-body'>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2 col-xs-6">
                                    <input class="mui-switch mui-switch-animbg" id="supplier_apply_reject" type="checkbox"
                                           @if(\app\common\models\notice\MessageTemp::getIsDefaultById($set['supplier_apply_reject']))
                                           checked
                                           @endif
                                           onclick="message_default(this.id)"/>
                                </div>
                    ...
                    <div class='panel-body'>
                        <div class="form-group">
                            ...
                            <div class="col-sm-2 col-xs-6">
                                <input class="mui-switch mui-switch-animbg" id="supplier_apply_pass" type="checkbox"
                                       @if(\app\common\models\notice\MessageTemp::getIsDefaultById($set['supplier_apply_pass']))
                                       checked
                                       @endif
                                       onclick="message_default(this.id)"/>
                            </div>
    ...
    <script>
        ...
        $(function () {
            ...
            $(":checkbox[name='setdata[withdraw_types][1]']").click(function () {
                if ($(this).is(":checked")) {
                    $("#wechat_withdraw_limit").css("display", "block");
                } else {
                    $("#wechat_withdraw_limit").css("display", "none");
                }
            });

            $(":checkbox[name='setdata[withdraw_types][2]']").click(function () {
                if ($(this).is(":checked")) {
                    $("#alipay_withdraw_limit").css("display", "block");
                } else {
                    $("#alipay_withdraw_limit").css("display", "none");
                }
            });
            ...
            var id = "#" + name;
            var setting_name = "plugin.supplier";
        ...
        // function formcheck(){
        //     var wechat_min        = $("input[name='setdata[wechat_min]']").val() ;
        //     var wechat_max        = $("input[name='setdata[wechat_max]']").val()  ;
        //     var wechat_frequency  = $("input[name='setdata[wechat_frequency]']").val() ;
        //     var alipay_min        = $("input[name='setdata[alipay_min]']").val() ;
        //     var alipay_max        = $("input[name='setdata[alipay_max]']").val() ;
        //     var alipay_frequency  = $("input[name='setdata[alipay_frequency]']").val();
        //
        //     if($(":checkbox[name='setdata[withdraw_types][1]']").is(":checked")){
        //         if(wechat_min < 1 ){
        //             showPopover($("input[name='setdata[wechat_min]']"),'不能小于1');
        //             return false;
        //         }
        //         if(wechat_max > 20000){
        //             showPopover($("input[name='setdata[wechat_max]']"),'不能大于20000');
        //             return false;
        //         }
        //         if( wechat_frequency < 1 || wechat_frequency > 10){
        //             showPopover($("input[name='setdata[wechat_frequency]']"),'可设置区间为1-10');
        //             return false;
        //         }
        //     }
        //     if($(":checkbox[name='setdata[withdraw_types][2]']").is(":checked")) {
        //         if (alipay_min < 1) {
        //             showPopover($("input[name='setdata[alipay_min]']"), '不能小于1');
        //             return false;
        //         }
        //         if (alipay_max > 20000) {
        //             showPopover($("input[name='setdata[alipay_max]']"), '不能大于20000');
        //             return false;
        //         }
        //         if (alipay_frequency < 1 || alipay_frequency > 10) {
        //             showPopover($("input[name='setdata[alipay_frequency]']"), '可设置区间为1-10');
        //             return false;
        //         }
        //     }
        //
