...
class ThumbController extends MaterialController
{
    // 上传图片最大字节
    const IMAGE_SIZE_LIMIT = 65536;
...
//            } else
    ...
    public function uploadWechat($coreAttach)
    {
        ...
        try {
            $media = $material->uploadThumb(Helper::getRootName().$coreAttach->attachment);// 绝对路径
        ...
        // 保存微信素材表
        $result =  WechatAttachmentImage::saveWechatAttachment($media,WechatAttachmentImage::ATTACHMENT_TYPE_THUMB,$coreAttach);
        return $result;
    }
