...
@section('content')
    ...
    <link rel="stylesheet" href="{{ plugin_assets('article', 'assets/css/article.css') }}" />
        ...
        <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
                  ...
                  /*  $("#select-good-btn").click(function(){
                    ...
                    $(".addbtn").click(function(){
                        ...
                        if(num<5){
                            ...
                            html+='<div class="img"><img src="' + webroot + 'plugin/article/template/imgsrc/nochooseimg.jpg" data-id="PAI-'+id+'" /></div>';
                            html+='<div class="info">';
                            ...
                            html+='<input type="text" name="article[advs][' + num + '][img]" class="form-control post-adv-img" placeholder="推广广告图，可直接输入或者选择系统图片 (请以http://开头)" data-id="PAI-'+id+'">';
                            ...
                            html+='<input type="text" name="article[advs][' + num + '][url]" class="form-control post-adv-link" placeholder="推广广告链接，可直接输入或者选择系统连接 (请以http://开头，单规格商品可直接下单)" data-id="PAL-'+id+'" value="1">';
            ...
            <div class="page-heading">
                <span class="pull-right">
                    ...
                    <input type="hidden" value="" name="article[content]" id="getContent">
            ...
            <!-- mylink start -->
            @include('Yunshop\Article::admin.mylink')
            <!-- mylink end -->

            <div class="fart-main">
                <!--左侧预览页面-->
                <div class="fart-preview">
                    <div class="top"><p bind-to="art_title"> @if ($article['id']){{ $article['title'] }} @else 这里是文章标题 @endif</p></div>
                    <div class="fart-rich-primary">
                        <div class="fart-rich-title" bind-to="art_title"> @if($article['id']){{ $article['title'] }}@else 这里是文章标题 @endif</div>
                        <div class="fart-rich-mate">
                            <div class="fart-rich-mate-text" bind-to="art_date_v"> @if ($article['id']){{ date('Y-m-d',$article['virtual_create_at']) }} @else {{ date('Y-m-d') }} @endif</div>
                            <div class="fart-rich-mate-text" bind-to="art_author"> @if ($article['id']){{ $article['author'] }} @else 编辑小芸 @endif</div>
                            <div class="fart-rich-mate-text href" bind-to="art_mp"> @if ($article['id']){{ $article['uniacid'] }} @else  测试公众号 @endif</div>
                        </div>
                        ...
                        <div class="fart-rich-tool">
                            ...
                            <div class="fart-rich-tool-text" bind-to="art_read">阅读 @if ($article['id']) @if ($article['virtual_read_num']>100000) 100000+ @else {{ $article['virtual_read_num'] }} @endif @else 100000+ @endif</div>
                            <div class="fart-rich-tool-text">
                                <div class="fart-rich-tool-like"></div>
                                <span bind-to="art_like">@if ($article['id']) @if ($article['virtual_like_num']>100000) 100000+ @else {{ $article['virtual_like_num'] }} @endif @else 54321 @endif</span>
                            </div>
                            <div class="fart-rich-tool-text right">举报</div>
                        </div>
                    </div>
                    <div class="fart-rich-sift product" @if($article['advs_type']!=0)style="display:block;"@endif>
                        <div class="fart-rich-sift-line">
                            <div class="fart-rich-sift-border"></div>
                            {{--下面代码需要重新审核 todo: aid未知--}}
                            <div class="fart-rich-sift-text"><a bind-to="product_adv_title">@if($aid){{$article['advs_title']}}@else精品推荐@endif</a></div>
                        </div>
                        <div class="fart-rich-sift-img"><img src="{{resource_get('plugin/article/template/imgsrc/img01.jpg', 1)}}"></div>
                        <div class="fart-rich-sift-more" bind-to="product_adv_more">@if($aid){{$article['advs_more']}}@else更多精品@endif</div>
                    </div>
                </div>
                <!--end 左侧预览页面-->
                                ...
                                <form>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            ...
                                            <input type="text" name="article[title]" class="form-control judge" value="{{ $article['title'] }}" placeholder="请填写文章标题 (30个汉字以内)" bind-in="art_title" bind-de="这里是文章标题">
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            ...
                                            <div class="form-control">&nbsp;
                                                <label for="" class="radio-inline"><input type="radio" name="article[type]" value="0" id="" @if ($article['type'] == 0) checked="true" @endif> 普通文章</label>&nbsp;&nbsp;&nbsp;
                                                <label for="" class="radio-inline"><input type="radio" name="article[type]" value="1" id="" @if ($article['type'] == 1) checked="true" @endif> 音频文章</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="line">
                                        <div class="input-group form-group">
                                            ...
                                            <input type="text" name="article[audio_link]'" class="form-control judge" value="{{ $article['audio_link'] }}">
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            <span class="input-group-addon">文章排序</span>
                                            <input type="text" name="article[display_order]'" class="form-control judge" value="{{ $article['display_order']?:0 }}">
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            <span class="input-group-addon">文章分类</span>
                                            <select class="form-control tpl-category-parent" name="article[category_id]" id="select1">
                                    ...
                                    <div class="line">
                                        <div class="input-group form-group">
                                            ...
                                            <input type="text" name="article[author]" class="form-control" value="{{ $article['author'] }} " placeholder="请填写发布作者 (不填则不显示)" bind-in="art_author" bind-de="编辑小芸">
                                        </div>
                                    </div>
                                    ...
                                    <div class="line">
                                        <div class="input-group form-group">
                                            ...
                                            <div class="form-control" style="height: auto">
                                                <label for="page_set_option2" class="checkbox-inline"><input type="checkbox" name="article[no_copy_url]" value="1" id="page_set_option2" @if ($article['no_copy_url'] == '1') checked="checked" @endif> 禁止复制链接</label>
                                                <label for="page_set_option3" class="checkbox-inline"><input type="checkbox" name="article[no_share]" value="1" id="page_set_option3" @if ($article['no_share'] == '1') checked="checked" @endif> 禁止分享至朋友圈</label>
                                                <label for="page_set_option1" class="checkbox-inline"><input type="checkbox" name="article[no_share_to_friend]" value="1" id="page_set_option1" @if ($article['no_share_to_friend'] == '1') checked="checked" @endif> 禁止分享给好友</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            ...
                                            <div class="form-control">
                                                <label for="article_report1" class="radio-inline"><input type="radio" name="article[report_enabled]" value="1" id="article_report1" @if ($article['report_enabled'] == 1) checked="true" @endif> 模拟举报(使用有风险)</label>&nbsp;&nbsp;&nbsp;
                                                <label for="article_report0" class="radio-inline"><input type="radio" name="article[report_enabled]" value="0" id="article_report0" @if ($article['report_enabled'] == 0) checked="true" @endif> 不显示</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            ...
                                            <div class="form-control">
                                                <label for="article_state_1" class="radio-inline"><input type="radio" name="article[state]" value="1" id="article_state_1" @if ($article['id'] && $article['state'] == 1) checked="true" @endif> 开启</label>
                                                <label for="article_state_0" class="radio-inline"><input type="radio" name="article[state]" value="0" id="article_state_0" @if (!$article['id'] || $article['state'] == 0) checked="true" @endif> 关闭</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            ...
                                            <input type="text" name="article[keyword]" class="form-control judge" value="{{ $article['keyword'] }}" placeholder="页面关键字">
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            <span class="input-group-addon">虚拟阅读数量</span>
                                            <input type="number" name="article[virtual_read_num]" class="form-control judge" value="{{  $article['virtual_read_num'] }}" placeholder="页面阅读量 = 真实阅读量 + 虚拟阅读量" bind-in="art_read" bind-de="100000+">
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            <span class="input-group-addon">虚拟点赞数量</span>
                                            <input type="number" name="article[virtual_like_num]" class="form-control judge" value="{{  $article['virtual_like_num'] }}" placeholder="页面点赞数 = 真实点赞数 + 虚拟点赞数" bind-in="art_like" bind-de="54321">
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            <span class="input-group-addon">虚拟发布时间</span>
                                            <input type="text" name="article[virtual_created_at]" class="form-control judge" style="padding-left: 12px; " value="@if ($article['id'] && !empty($article['virtual_created_at'])) {{ date('Y-m-d', $article['virtual_created_at']) }} @else {{ date('Y-m-d') }} @endif" placeholder="虚拟发布时间 (格式: {{ date('Y-m-d') }})" bind-in="art_date_v" bind-de="{{ date('Y-m-d') }}">
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            <span class="input-group-addon">阅读原文链接</span>
                                            <input type="text" name="article[link]"  class="form-control" value="{{  $article['link'] }}" placeholder="请填写阅读原文指向的链接 (请以http://开头, 不填则不显示)" data-id="PAL-00010">
                                    ...
                                    <div class="line">
                                        <div class="input-group form-group">
                                            ...
                                            <input type="text" name="article[desc]" class="form-control" value="{{ $article['desc'] }}" placeholder="文章介绍(封面 50字以内)">
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            <span class="input-group-addon">文章图片(封面)</span>
                                            <input type="text" name="article[thumb]" class="form-control" value="{{ $article['thumb'] }}" data-id="resp_img">
                                        ...
                                        <div class="input-group form-group">
                                            ...
                                            <div class="form-control" style="height: auto">
                                                    <label class="checkbox-inline" style="margin-left: 10px">
                                                        <input type="checkbox" class='chkall' name="article[show_levels]" value="" @if ( $article['show_levels']=='') checked="true" @endif  /> 全部会员等级
                                                    </label>
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" class='chksingle' name="article[show_levels][]" value="0" @if ( $article['show_levels'] != '' && is_array($article['show_levels']) && in_array('0', $article['show_levels'])) checked="true" @endif  />  普通等级
                                                    </label>
                                                @foreach ( $levels as $level)
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" class='chksingle' name="article[show_levels][]" value="{{ $level['id'] }}" @if ( $article['show_levels'] != '' && is_array($article['show_levels'])  && in_array($level['id'], $article['show_levels'])) checked="true" @endif  /> {{ $level['level_name'] }}
                                                    </label>
                                                @endforeach
                                            </div>
                                        </div>
                        ...
                        <div class="fart-editor-content" step="1" style="display: block;"><!--编辑文章内容-->
                            ...
                            <div class="content">
                                <div class="con1" style="width:100% !important;">
                                    <textarea id="editor" style="width:100%;">{!! htmlspecialchars_decode($article['content']) !!}</textarea>
                                    {{--<script id="editor" style="width:100%;">{!! htmlspecialchars_decode($article['content']) !!}</script>--}}
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="fart-form">
                                <div class="line">
                                    <div class="line2" style="margin-right: 10px;">
                                        <div class="input-group form-group">
                                            ...
                                            <input type="text" name="article[per_person_per_day]" style="width: 60px" class="form-control judge" value="{{ $article['per_person_per_day'] }}">
                                            <span class="input-group-addon" style="border-left: 0px; border-right: 0px;">次&nbsp;&nbsp;每人总共奖励</span>
                                            <input type="text" name="article[total_per_person]" style="width: 60px" class="form-control judge" value="{{ $article['total_per_person'] }}" >
                                ...
                                <div class="line">
                                    <div class="line2" >
                                        <div class="input-group form-group">
                                            ...
                                            <input type="text" name="article[point]" style="width: 90px" class="form-control judge" value="{{ $article['point'] }}" >
                                            <span class="input-group-addon" style="border-left: 0px; border-right: 0px;">个积分</span>
                                            <input type="text" name="article[credit]" style="width: 115px" class="form-control judge" value="{{ $article['credit'] }}">
                                        ...
                                        <div class="input-group form-group" >
                                            ...
                                            <div class="form-control" style="width: 390px">
                                                <label class="radio-inline" style="padding: 0 60px;">
                                                    <input type="radio" name="article[reward_mode]" value="0" @if ($article['reward_mode'] == 0) checked="true" @endif >按次
                                                </label>
                                                <label class="radio-inline" style="padding-top: 0;">
                                                    <input type="radio" name="article[reward_mode]" value="1" @if ($article['reward_mode'] == 1) checked="true" @endif>按天
                                                </label>
                                            </div>
                                        </div>
                                        <div class="input-group form-group">
                                            <span class="input-group-addon" style="border-right: 0px;">最高累计奖金</span>
                                            <input type="text" name="article[bonus_total]" style="width: 180px"  class="form-control" value="{{ $article['bonus_total'] }}" placeholder="">
                                ...
                                <div class="line">
                                    <div class="input-group form-group">
                                        ...
                                        <div class="form-control">&nbsp;
                                            <label for="product_advs_type1" class="radio-inline"><input type="radio" class="product_advs_type" name="article[advs_type]" value="0" id="product_advs_type1" @if ($article['advs_type'] == 0) checked="true" @endif> 关闭此功能</label>&nbsp;&nbsp;&nbsp;
                                            <label for="product_advs_type2" class="radio-inline"><input type="radio" class="product_advs_type" name="article[advs_type]" value="1" id="product_advs_type2" @if ($article['advs_type'] == 1) checked="true" @endif> 启用此功能</label>&nbsp;&nbsp;&nbsp;
                                            {{--<label for="product_advs_type3" class="radio-inline"><input type="radio" class="product_advs_type" name="article[advs_type]" value="2" id="product_advs_type3" @if ($article['advs_type'] == 2) checked="true" @endif> 随机显示</label>&nbsp;&nbsp;&nbsp;--}}
                                            {{--<label for="product_advs_type4" class="radio-inline"><input type="radio" class="product_advs_type" name="article[advs_type]" value="3" id="product_advs_type4" @if ($article['advs_type'] == 3) checked="true" @endif> 轮播显示</label>--}}
                                        </div>
                                    </div>
                                </div>
                                <div class="product" style="display:block;" >
                                    <div class="line">
                                        <div class="input-group form-group">
                                            ...
                                            <input type="text" name="article[advs_title]"  class="form-control" value="{{ $article['advs_title'] }}" placeholder="推广产品标题，不填则不显示标题" bind-in="product_adv_title" bind-de="精品推荐">
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            <span class="input-group-addon">推广产品底部文字</span>
                                            <input type="text" name="article[advs_title_footer]"  class="form-control" value="{{ $article['advs_title_footer'] }}" placeholder="推广产品底部文字，不填则不显示" bind-in="product_adv_more" bind-de="更多精彩">
                                        </div>
                                    </div>
                                    <div class="line">
                                        <div class="input-group form-group">
                                            <span class="input-group-addon">推广产品底部链接</span>
                                            <input type="text" name="article[advs_link]"  class="form-control" value="{{ $article['advs_link'] }}" placeholder="推广产品底部文字链接，可直接输入或者选择系统连接 (请以http://开头)" data-id="PAL-00000">
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        {!!tpl_form_field_image('article[advs_img]',$article['advs_img'])!!}
                                ...
                                <div class="advs">
                                    <div id="advs">
                                        @if (!empty($article['advs']))
                                        @foreach ($article['advs'] as $i => $adv)
                                        <div class="adv">
                                            <div class="del">×</div>
                                            <div class="img"><img src="@if (empty($adv['img']))../addons/sz_yi/plugin/article/template/imgsrc/nochooseimg.jpg @else {{  $adv['img'] }} @endif" data-id="PAI-{{ time()+$i+1 }}" /></div>
                                            <div class="info">
                                                <div class="input-group form-group" style="margin-top:5px; margin-bottom:0px; margin-right:5px;">
                                                    ...
                                                    <input type="text" name="article[advs][{{ $i }}][img]" class="form-control post-adv-img" placeholder="推广广告图，可直接输入或者选择系统图片 (请以http://开头)" value="{{  $adv['img'] }}" data-id="PAI-{{ time()+$i+1 }}">
                                                ...
                                                <div class="input-group form-group" style="margin-top:10px; margin-bottom:0px; margin-right:5px;">
                                                    ...
                                                    <input type="text" name="article[advs][{{ $i }}][url]" class="form-control post-adv-link" placeholder="推广广告链接，可直接输入或者选择系统连接 (请以http://开头，单规格商品可直接下单)" value="{{ $adv['url'] }}" data-id="PAL-{{ time()+$i+1 }}" >
