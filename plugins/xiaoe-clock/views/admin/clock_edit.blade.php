...
@section('content')
    @if($type=='1')
        <div class="right-titpos">
            <ul class="add-snav">
                <li class="active"><a href="#">编辑日历打卡&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red"> 请谨慎填写。</span></a></li>
            </ul>
        </div>
    @endif
    @if($type=='2')
        <div class="right-titpos">
            <ul class="add-snav">
                <li class="active"><a href="#">编辑作业打卡&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: red"> 请谨慎填写。</span></a></li>
            </ul>
        </div>
    @endif
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12 col-md-11">
                            <label class="radio-inline">
                                <input type="radio" name="join_type" value="1" @if($info['join_type'] == 1) checked="checked" @endif />购买课程
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="join_type" value="0" @if($info['join_type'] == 0) checked="checked" @endif />免费课程
                            </label>
                        </div>
                    </div>
                    <div class="form-group goods-div" @if($info['join_type'] == 0) style="display: none; @endif">
                        <label class="col-xs-12 col-sm-3 col-md-1 control-label">关联课程</label>
                        <div class="col-sm-9 col-xs-12 col-md-11">
                            <input name="course_id" type="hidden" class="form-control" value="{{ $info['course_id'] }}"/>
                            <input class="form-control" type="text" placeholder="请选择课程" value="{{ $info['course_name'] }}" id="course_name"
...
{{--                    </div>--}}
                ...
                @if($type=='2')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12 col-md-11">
                            <label class="radio-inline">
                                <input type="radio" name="is_cheat_mode" value="0"  @if($info['is_cheat_mode'] == 0) checked="checked" @endif/> 关闭
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="is_cheat_mode" value="1" @if($info['is_cheat_mode'] == 1) checked="checked" @endif/> 开启
                            </label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9 col-xs-12 col-md-11">
                            <label class="radio-inline">
                                <input type="radio" name="is_resubmit" value="0" @if($info['is_resubmit'] == 0) checked="checked" @endif/> 关闭
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="is_resubmit" value="1" @if($info['is_resubmit'] == 1) checked="checked" @endif/> 开启
                            </label>
