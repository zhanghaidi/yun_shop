        ...
        <div class="panel-body">
            ...
            <div class="top" style="margin-bottom:20px">
                <ul class="add-shopnav" id="myTab">
                    ...
                    <li class="active"><a href="{{yzWebUrl('plugin.minapp-content.admin.cos-video.index')}}">敏感视频管理</a></li>
                </ul>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @elseif($value['forbidden_status'] == 1) 已被冻结
                            @endif
                        </td>
                        <td>
                        ...
                        <td class="text-right">
                            <a href="{{ yzWebUrl('plugin.minapp-content.admin.cos-video.delete', ['id' => $value['id']]) }}" onclick="return confirm('确定删除吗');return false;"  title="删除"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
