        ...
        <div class="panel-body">
            ...
            <form id="form" action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9 col-md-10">
                        <input type="radio" id="type-0" name="type" value="1" @if($info['status']==0) selected @endif>
                        <label class="radio-inline" for="type-0">穴位快评</label>
                        <input type="radio" id="type-1" name="type" value="3" @if($info['status']==0) selected @endif >
                        <label class="radio-inline" for="type-1">文章快评</label>
                        <input type="radio" id="type-2" name="type" value="4" @if($info['status']==0) selected @endif >
                        <label class="radio-inline" for="type-2">帖子快评</label>
                        <input type="radio" id="type-3" name="type" value="5" @if($info['status']==0) selected @endif >
                        <label class="radio-inline" for="type-3">课程快评</label>
                        <input type="radio" id="type-4" name="type" value="6" @if($info['status']==0) selected @endif >
                        <label class="radio-inline" for="type-4">灸师快评</label>
                        <input type="radio" id="type-5" name="type" value="7" @if($info['status']==0) selected @endif >
