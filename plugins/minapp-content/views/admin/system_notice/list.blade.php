        ...
        <div class="panel-body">
            ...
            <div class="top" style="margin-bottom:20px">
                <ul class="add-shopnav" id="myTab">
                    ...
                    <li class="active"><a href="{{yzWebUrl('plugin.minapp-content.admin.system-notice.index')}}">系统通知</a>
                </ul>
            </div>
            ...
            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                <a href="{{ yzWebUrl('plugin.minapp-content.admin.system-notice.edit') }}" class="btn btn-info">添加通知</a>
            </div>
        </div>
    </div>
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$value['content']}}</td>
                        <td>
                            <a href="{{ yzWebUrl('plugin.minapp-content.admin.system-notice.status', ['id' => $value['id']]) }}">
                            @if($value['status'] == 1)
                        ...
                        <td class="text-right">
                            <a href="{{ yzWebUrl('plugin.minapp-content.admin.system-notice.edit', ['id' => $value['id']]) }}" title="编辑"><i class="fa fa-edit"></i></a> &nbsp; 
                            <a href="{{ yzWebUrl('plugin.minapp-content.admin.system-notice.delete', ['id' => $value['id']]) }}" onclick="return confirm('确定删除吗');return false;"  title="删除"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
