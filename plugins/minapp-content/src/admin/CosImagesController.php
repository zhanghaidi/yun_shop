...
use Yunshop\MinappContent\models\CosImagesModel;
use Yunshop\MinappContent\services\MinappContentService;

class CosImagesController extends BaseController
{
    private $pageSize = 20;
    ...
    public function index()
    {
        ...
        unset($v);
        return view('Yunshop\MinappContent::admin.cos_images.list', [
    ...
    public function delete()
    {
        ...
        CosImagesModel::where('id', $id)->delete();
