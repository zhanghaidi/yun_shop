...
class MemberCenterService
{
    public function getMemberData($memberId)
    {
        ...
        $diyarr = [
            'tool'         => ['separate','elive','member_code','member_pay_code', 'signIndex', 'converge_pay','room-aide'],
            'asset_equity' => ['integral', 'credit', 'asset', 'love', 'coin','froze','extension', 'dragon_deposit'],
            'merchant'     => ['supplier', 'kingtimes', 'hotel', 'store-cashier', 'cashier', 'micro', 'delivery_station', 'service_station', 'voice-goods', 'staging_buy_car', 'package_deliver','appointment','room-apply','subsidiary','auction'],
            'market'       => [
                ...
                'exchange','micro-communities','bonus-pool', 'advert-market','room','easy-refuel', 'channel','commission-activity',
            ]
