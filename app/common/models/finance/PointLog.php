    ...
    public function getModeNameAttribute()
    {
        ...
        switch ($this->point_mode) {
            ...
            case (17):
                ...
                break;
            case (126):
                $mode_attribute = PointService::POINT_MODE_DISCUSS_REWARD_ATTACHED;
                break;
            case (127):
                $mode_attribute = PointService::POINT_MODE_STEPS_REWARD_ATTACHED;
                break;
            case (18):
            ...
            case (45):
                ...
                break;
            case (46):
                $mode_attribute = PointService::POINT_AUCTION_REWARD_RECIPIENT_POINTS_ATTACHED;
                break;
            case (47):
                $mode_attribute = PointService::POINT_INCOME_WITHDRAW_AWARD_ATTACHED;
                break;
            case (48):
                $mode_attribute = PointService::POINT_GIVE_BACK_ATTACHED;
                break;
            case (49):
                $mode_attribute = PointService::POINT_GIVE_BACK_UNENOUGH_ATTACHED;
                break;
            case (50):
