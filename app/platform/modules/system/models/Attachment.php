...
//                break;
            ...
            case '重庆':
                ...
                break;
            case '新加坡':
                $cos['local'] = 'ap-singapore';
                break;
            case '香港':
                $cos['local'] = 'ap-hongkong';
                break;
            case '多伦多':
                $cos['local'] = 'na-toronto';
                break;
            case '法兰克福':
                $cos['local'] = 'eu-frankfurt';
                break;
        }
...
//                return ['msg' => 'OSS-Access Key ID 或 OSS-Access Key Secret错误，请重新填写'];
            ...
            //}
            $auth = attachment_cos_auth($remotes['cos']['bucket'], $remotes['cos']['appid'], $remotes['cos']['secretid'], $remotes['cos']['secretkey'], $remotes['cos']['local'], $remotes['cos']['region']);
