    ...
    private function getCouponLogRemark()
    {
        ...
        switch ($this->get_type) {
            ...
            case '6':
                ...
                break;
            case '7':
                $remark = '直播会员观看奖励: 会员【ID:' . $this->memberId . '】获得优惠券 1张【优惠券ID:' . $this->couponId . '】';
                break;
            case '8':
                $remark = '直播间会员奖励: 会员【ID:' . $this->memberId . '】获得优惠券 1张【优惠券ID:' . $this->couponId . '】';
                break;
            case '9':
