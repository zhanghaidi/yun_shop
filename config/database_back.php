...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'sqlite' => [
            'driver' => 'sqlite',
            'database' => config('app_env.DB_DATABASE', database_path('database.sqlite')),
            'prefix' => '',
        ],

        'mysql' => [
            'driver' => 'mysql',
            'host' => config('app_env.DB_HOST', $default_host),
            'port' => config('app_env.DB_PORT', $default_port),
            'database' => config('app_env.DB_DATABASE', $default_db),
            'username' => config('app_env.DB_USERNAME', $default_username),
            'password' => config('app_env.DB_PASSWORD', $default_password),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => config('app_env.DB_PREFIX', $default_prefix),
            'strict' => false,
            'engine' => null,
            'loggingQueries'=>true,
            'options'   => [
                \PDO::ATTR_EMULATE_PREPARES => config('app_env.DB_PREPARED', false)
            ]
        ...
        'pgsql' => [
            'driver' => 'pgsql',
            'host' => env('app_env.DB_HOST', '127.0.0.1'),
            'port' => env('app_env.DB_PORT', '5432'),
            'database' => env('app_env.DB_DATABASE', 'forge'),
            'username' => env('app_env.DB_USERNAME', 'forge'),
            'password' => env('app_env.DB_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'schema' => 'public',
            'sslmode' => 'prefer',
        ...
        'mysql_slave' => [
            ...
            'read' => [
                'host'      => config('app_env.DB_SLAVE_HOST', $default_slave_host),
                'database'  => config('app_env.DB_SLAVE_DATABASE', $default_slave_db),
            ],
            'port' => config('app_env.DB_PORT', $default_port),
            'username' => config('app_env.DB_USERNAME', $default_username),
            'password' => config('app_env.DB_PASSWORD', $default_password),
