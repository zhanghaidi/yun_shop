...
'fetch' => \PDO::FETCH_ASSOC,
    ...
    */
    ...
    'mysql_slave' => [
        ...
        'port' => env('DB_PORT', $default_slave_port),
        'database' => env('DB_DATABASE', $default_slave_db),
        'username' => env('DB_USERNAME', $default_slave_username),
        'password' => env('DB_PASSWORD', $default_slave_password),
        'charset' => 'utf8mb4',
        'collation' => 'utf8mb4_unicode_ci',
        'prefix' => env('DB_PREFIX', $default_prefix),
        'strict' => false,
